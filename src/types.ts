...
export const FirmResourceSchema = z.object({
  ...
  type_juridique: z.string().nullable(),
  siret: z.string().nullable(),
  entite_rattachement: z.string().nullable(),
  adresse_entite_rattachement: z.string().nullable(),
  numero_tva: z.string().nullable(),
  adresse: z.object({
    adresse_1: z.string().nullable(),
    adresse_2: z.string().nullable().optional(),
    adresse_3: z.string().nullable().optional(),
